...
public class Gmail {
	...
	def String getOTPGmail(String email_subject) {

		String host = 'mail.google.com'

		String username = 'john.doe.katalon@gmail.com'

		String password = 'huir adhk aaqs jkks'
	...
	def extractOTP(String msgcontent) {
		Pattern p1 = Pattern.compile('This is your OTP for Gmail ([0-4]+).')
